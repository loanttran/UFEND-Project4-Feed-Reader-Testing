...
<p>Click here to run the app: https://loanttran.github.io/UFEND-Project4-Feed-Reader-Testing/ </p>
<p>All the written tests are in <strong>/jasmine/spec/feedreader.js</strong></p>
